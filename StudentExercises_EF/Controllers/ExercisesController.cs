...
namespace StudentExercises_EF.Controllers
{
    public class ExercisesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ExerciseName,ExerciseLanguage")] Exercises exercises)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ExerciseName,ExerciseLanguage")] Exercises exercises)
        {
            if (id != exercises.Id)
            {
                return NotFound();
